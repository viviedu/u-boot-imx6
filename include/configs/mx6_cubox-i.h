...
#define CONFIG_BOOTCOMMAND \
  ...
  /* how to set bootargs */ \
  "setenv basebootargs 'console=ttymxc0,115200 video=mxcfb0:dev=hdmi,1920x1080M@60 quiet consoleblank=0'; " \
  "setenv extrabootargs 'fec.disable_giga=1 logo.nologo=1'; " \
